...
The purpose of this research is to evaluate the real-time data collected through the Automated Traffic Signal Performance Measures (ATSPMs) database and determine which performance measures can be used for evaluation and to then identify thresholds for each performance measure chosen. The goal of this website is to introduce the process of this resesarch project. The following sections include:
...
#### What is ATSPM
 ...
 - ATSPM use high-resolution data capability added to existing infrastructure to evaluate the quality of progression of traffic along a corridor.
 - ATSPM data provide insight into vehicle delay from volume, speed, and travel time detection. 
 - Utah Departement of Transportation (UDOT) uses the data to optimize mobility and manage traffic signal timing and maintenance to reduce congestion, save fuel costs, and improve safety.
...
Figure 1 shows the example of ATSPM data plot

  ![**FIGURE 1. EXAMPLE OF ATSPM DATA PLOT.**](img/Picture1.png)
