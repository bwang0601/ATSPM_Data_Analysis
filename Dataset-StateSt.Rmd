...
RA_StateSt <-read_xls("ATSPM/data/StateSt/StateSt_RedActuation.xls") %>%
  mutate(
...
PCD_StateSt <-read_xls("ATSPM/data/StateSt/StateSt_PCD.xls") %>% 
  mutate(
    BinStartTime = as_datetime(BinStartTime),
    SignalId = as.numeric(SignalId),
...
SF_StateSt <-read_xls("ATSPM/data/StateSt/StateSt_SplitFail.xls") %>% 
  mutate(
    BinStartTime = as_datetime(BinStartTime),
    SignalId = as.numeric(SignalId)
  )  
...
PPT_StateSt <-read_xls("ATSPM/data/StateSt/StateSt_PPT.xls") %>% 
  mutate(
    BinStartTime = as_datetime(BinStartTime),
    SignalId = as.numeric(SignalId)
  )
...
Cyc_StateSt <-read_xls("ATSPM/data/StateSt/StateSt_Cycles.xls") %>%
  mutate(
    BinStartTime = as_datetime(BinStartTime),
    SignalId = as.numeric(SignalId)
  )
...
BaseTable_StateSt <-read_xls("ATSPM/data/StateSt/StateSt_BaseTable.xls") %>%
  mutate(
    BinStartTime = as_datetime(BinStartTime),
    SignalId = as.numeric(SignalId),
